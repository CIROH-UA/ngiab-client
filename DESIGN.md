...
**Contrast is solved, not chosen.** Every semantic role was computed to land at **≥5:1** against
its own surface, leaving headroom over the 4.5:1 AA floor. Reproduce with the OKLCH solver rather
than nudging hex values by eye:

| Role | Light | Dark |
|---|---|---|
| `--accent` | 5.03:1 | 5.01:1 |
| `--danger` | 5.03:1 | 5.01:1 |
| `--warning` | 5.02:1 | 5.03:1 |
| `--fg` | 16.3:1 | 15.3:1 |
